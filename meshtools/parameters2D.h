...
std::vector<double> filaparams{40.0, 0, 0}; //length, amplitude, length1, length2
...
std::vector<std::vector<double>> spanparams{{4.0, 0.866025, 0.50, 0.2928}, {4.0, 0.866025, 0.50, 0.2908}}; 
